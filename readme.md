...
```bash
thread 'main' panicked at src/runtime/methods/step.rs:1338:25:
...
```bash
 ERROR wasp::testsuite > Got error "hit an unreachable code segment: src/runtime/methods/step.rs:279:25", expected error: "unreachable" (module: 0, function "type-i32")
```
...
```bash
 ERROR wasp::testsuite > Got error "hit an unreachable code segment: src/runtime/methods/step.rs:279:25", expected error: "unreachable" (module: 0, function "func-unwind-by-unreachable")
```

...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:468:42:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:368:32:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
 ERROR wasp::testsuite > test 1/5 failed (module: 0, invoke: "even", error: empty stack: src/runtime/mod.rs:565:55)
```

## Failed: test-suite/test/core/func.wast
```bash
thread 'main' panicked at src/runtime/typecheck.rs:287:32:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:279:33:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/mod.rs:997:25:
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:282:33:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:310:32:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:467:45:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:278:31:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:288:31:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:373:37:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:316:34:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```

...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:338:32:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:460:42:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:360:32:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:271:33:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:322:32:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:459:45:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:270:31:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:280:31:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
...
```bash
thread 'main' panicked at src/runtime/typecheck.rs:308:34:
not yet implemented
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```

            ...
            inst => {
                let TypingRules { input, output } = {
                    ...
                    match this {
                        ...
                        x21_local_set(LocalIdX(i)) => {
                            TypingRules::single_input(locals[*i as usize])
                        }
                        x22_local_tee(LocalIdX(i)) => TypingRules {
                            input: vec![locals[*i as usize]],
                            output: vec![locals[*i as usize]],
                        },
                        x23_global_get(GlobalIdX(i)) => {
                            TypingRules::single_output(globals[*i as usize])
                        }
                        x24_global_set(GlobalIdX(i)) => {
                            TypingRules::single_input(globals[*i as usize])
                        }
                        x25 => todo!(),
                        ...
                        x2c_i32_load8_s(_) => {
                            TypingRules::single_output(ValType::Num(NumType::I32))
                        }
                        x2d_i32_load8_u(_) => {
                            TypingRules::single_output(ValType::Num(NumType::I32))
                        }
                        ...
                        x30_i64_load8_s(_) => {
                            TypingRules::single_output(ValType::Num(NumType::I64))
                        }
                        x31_i64_load8_u(_) => {
                            TypingRules::single_output(ValType::Num(NumType::I64))
                        }
